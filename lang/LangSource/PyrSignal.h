...
PyrFloatArray* signal_insert(VMGlobals* g, PyrFloatArray* ina, PyrFloatArray* inb, long index);
...
PyrFloatArray* signal_linen(VMGlobals* g, PyrFloatArray* ina, long atk, long dcy, float amp);
PyrFloatArray* signal_linen2(VMGlobals* g, PyrFloatArray* ina, long atk, long dcy, float amp, float midamp);
...
PyrFloatArray* signal_splice(VMGlobals* g, PyrFloatArray* ina, PyrFloatArray* inb, long indexa, long indexb,
                             long fadelen, float midamp);
...
PyrFloatArray* signal_combself(VMGlobals* g, PyrFloatArray* ina, long rot);
PyrFloatArray* signal_bilinen(VMGlobals* g, PyrFloatArray* ina, long atk, long dcy, float amp, float midamp);
...
void signal_convolve(VMGlobals* g, PyrFloatArray* ina, PyrFloatArray* ir, PyrFloatArray* previn, long* ppos);
PyrFloatArray* signal_thumbnail(VMGlobals* g, PyrFloatArray* ina, long startpos, long length, int binsize);
...
PyrFloatArray* signal_zero_range(PyrFloatArray* ina, long start, long end);
...
PyrFloatArray* signal_fade_in(PyrFloatArray* ina, long start, long end);
PyrFloatArray* signal_fade_out(PyrFloatArray* ina, long start, long end);
PyrFloatArray* signal_abs_range(PyrFloatArray* ina, long start, long end);
PyrFloatArray* signal_squared_range(PyrFloatArray* ina, long start, long end);
PyrFloatArray* signal_cubed_range(PyrFloatArray* ina, long start, long end);
PyrFloatArray* signal_distort_range(PyrFloatArray* ina, long start, long end);
